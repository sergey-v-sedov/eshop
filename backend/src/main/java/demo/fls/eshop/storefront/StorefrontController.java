...
public class StorefrontController {
    @GetMapping
    public Collection<Product> get(@RequestParam(value = "q", required = false) String query) {
        Collection<Product> products = Arrays.asList(
                new Product(UUID.randomUUID(), "Samsung Galaxy",
                        ...
                        "Стилус: Стилус\n" +
                        "Прочее:\n" +
                        "Цвет: Graphite", URI.create("http://localhost:8080/img/acer.jpg"), 2215.0),
                ...
                new Product(UUID.randomUUID(), "ASUS Vivobook 17", "Тип: Ноутбук\n" +
                        ...
                        "Разрешение: 1920x1080", URI.create("http://localhost:8080/img/panasonic-toughbook.jpg"), 615.15)
        );
